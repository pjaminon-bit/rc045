...
return [
  ...
  [
    ...
    'tekst' => 'De site is drietalig, maar het omschakelen gebeurde pas in de browser. Google en zeker Facebook en WhatsApp kijken naar de pagina zoals die van de server komt, en die was altijd Nederlands: dezelfde Nederlandse titel voor alle drie de talen, en een Nederlandse omschrijving zodra iemand een Engelse of Duitse link deelde. Titel, omschrijving en deelbericht komen nu meteen in de goede taal van de server. De zes publieke pagina\'s hebben daarvoor een eigen Engelse en Duitse titel en omschrijving gekregen, en de sitemap vertelt Google nu ook dat de drie taalversies bij elkaar horen. De omschrijving van de homepage is in alle drie de talen ingekort, want Google kapt na ongeveer 155 tekens af en de laatste zin viel weg. Voor bezoekers verandert er niets, ook de adressen blijven hetzelfde.',
  ],
